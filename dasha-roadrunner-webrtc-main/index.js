...
// External function check status 
  app.setExternal("status", async(args, conv) => {
    ...
    return("Congratulations, Madam Nidhi Sethi Your application is approved. Ask me anything that would you like to know about Yoga, Exercise, Health, Diet or discuss mental health issues"); 
    else 
    return("Apologies, Madam Nidhi Sethi, Your application is not approved. ");
  });
