...
start node root {
    do {
        ...
        #waitForSpeech(1000);
        #sayText("Thank you for visitng the Y2K: Yoga to Correction health and relaxation website.");
        #sayText(" I'm your artificially intelligent agent Dasha Yoga. How can I help you today?");
        wait *;
    }
    transitions {
    }
...
digression status {
    ...
    do {
        #sayText("Great! To tell you your Yoga journey status till date, including your performance evaluation, consistency and other necessary information, but first I need to confirm your identity.");
        #sayText("It seems that you are logged in as, Ms. Somya from India. Can you please confirm the answer to the secret question for authentication purposes. ", options: { emotion: "from text: I love you", speed: 0.7 });
