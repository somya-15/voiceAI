...
start node root {
    do {
        ...
        #sayText(" I'm your artificially intelligent agent Worlds Most Intelligent Shruti Gupta. How can I help you today?");
        wait *;
    }
    transitions {
    }
...
digression status {
    ...
    do {
        #sayText("Great! To tell you your Yoga journey status till date, I need to confirm your identity.");
        #sayText("It seems that you are logged in as, Your Highness, the greatest queen of India, Madam Nidhi Sethi. Can you please confirm the answer to the secret question. ", options: { emotion: "from text: I hate you", speed: 0.7 });
